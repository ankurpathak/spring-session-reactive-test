...
public class EmailService implements IEmailService {
    ...
    public EmailService(JavaMailSender javaMailSender, Environment environment, MessageSource messageSource, IEmailTemplateService emailTemplateService, Validator validator) {
    ...
    public void sendUserEmail(User user, String subjectKey, String html) {
        ...
        if (!StringUtils.isEmpty(email)) {
            ...
            EmailUtil.sendHtmlMail(new SmtpContext(Collections.singletonList(emailContextUser), sender));
        }
